 ...
 */
final class Version20211004222058 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, room_id INTEGER DEFAULT NULL, content CLOB NOT NULL COLLATE BINARY)');
